...
export const success = <T>(
  ...
  data?: T,
  message?: string,
  meta?: any, // For backwards compatibility, will be ignored
  statusCode = 200
): Response => {
  // Handle pagination if it's in the old meta format
  let pagination;
...
/**
 * Error response helper - matches TradeByBarter format
 * Backwards compatible with old signature
 */
export const fail = (
  res: Response,
...
/**
 * Pagination meta helper - matches TradeByBarter format
 */
